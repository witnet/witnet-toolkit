...
import {
	...
	DataRequestPayload,
} from "../payloads/DataRequestPayload.js";
...
export class DataRequests extends TransmitterMultiSig<
	DataRequestParams,
	DataRequestPayload
> {
	...
	public static from(
		ledger: ILedger,
		artifact: RadonRequest | RadonTemplate,
	): DataRequests {
	...
	constructor(
		...
		super(
			"DRTransaction",
			new DataRequestPayload("DRTransactionBody", artifact),
			ledger,
			changePkh,
		);
	}
