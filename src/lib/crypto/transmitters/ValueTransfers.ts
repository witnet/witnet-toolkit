import {
	type ValueTransferParams,
	ValueTransferPayload,
} from "../payloads/ValueTransferPayload.js";
...
export class ValueTransfers extends TransmitterMultiSig<
	ValueTransferParams,
	ValueTransferPayload
> {
	...
	constructor(ledger: ILedger, changePkh?: PublicKeyHashString) {
		super(
			"VTTransaction",
			new ValueTransferPayload("VTTransactionBody"),
			ledger,
			changePkh,
		);
	}
